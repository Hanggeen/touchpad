...
(async function () {
  ...
  if (!code) {
    _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('无效的code');
    return;
  }

  if (!code) {
    _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('无效的websocket');
    return;
  }
  ...
  if (!res) {
    _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show(`[${code}]初始化失败`);
    return;
  } // 触摸板监听
  ...
  toucher.listen(msg => {
    ...
    if (msg.action === "touch") {
      _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('触发滑动');
    } else if (msg.action === "click") {
      _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('触发点击');
    }
  }); // 滚动条监听
  ...
  scroller.listen(msg => {
    ...
    _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('触发滚动');
  }); // 手势监听
  ...
  gesture.listen(msg => {
    ...
    if (msg.type === "swipeleft") {
      _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('向左滑动');
    } else if (msg.type === "swiperight") {
      _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('向右滑动');
    } else if (msg.type === "swipeup") {
      _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('向上滑动');
    } else if (msg.type === "swipedown") {
      _src_mobules_tips__WEBPACK_IMPORTED_MODULE_7__["default"].show('向下滑动');
