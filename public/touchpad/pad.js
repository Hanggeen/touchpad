...
/******/ 		return __webpack_require__.p + "" + ({"vendors~hammerjs":"vendors~hammerjs"}[chunkId]||chunkId) + ".bundle.js"
/******/ 	}
/******/
...
/* harmony import */ var _src_style_style_less__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/style/style.less */ "./src/pad/src/style/style.less");
/* harmony import */ var _src_style_style_less__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_src_style_style_less__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _src_mobules_server__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./src/mobules/server */ "./src/pad/src/mobules/server.js");
/* harmony import */ var _src_mobules_scroller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./src/mobules/scroller */ "./src/pad/src/mobules/scroller.js");
/* harmony import */ var _src_mobules_toucher__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./src/mobules/toucher */ "./src/pad/src/mobules/toucher.js");
...
/* harmony import */ var _src_common_tools__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./src/common/tools */ "./src/pad/src/common/tools.js");
/* harmony import */ var _src_common_tools__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_src_common_tools__WEBPACK_IMPORTED_MODULE_5__);
...
(async function () {
  let url = Object(_src_common_tools__WEBPACK_IMPORTED_MODULE_5__["getQuery"])('ws');
  let code = Object(_src_common_tools__WEBPACK_IMPORTED_MODULE_5__["getQuery"])('co');
  let wsurl;
  ...
  console.log(wsurl);
  const server = new _src_mobules_server__WEBPACK_IMPORTED_MODULE_1__["default"](wsurl, code);
  ...
  const scroller = new _src_mobules_scroller__WEBPACK_IMPORTED_MODULE_2__["default"](document.getElementById('bar'));
  ...
  const toucher = new _src_mobules_toucher__WEBPACK_IMPORTED_MODULE_3__["default"](document.getElementById('pad'));
  toucher.listen(msg => {
    server.send({
      type: 'track',
      track: {
  ...
  if (res.gesture) {
    const gesture = new _src_mobules_gesture__WEBPACK_IMPORTED_MODULE_4__["default"](document.getElementById('bar'));
    await gesture.init();
    gesture.listen(msg => {
      server.send({
        type: 'track',
...
class Gesture {
  ...
  getHammer() {
    return new Promise((resolve, reject) => {
      __webpack_require__.e(/*! import() | hammerjs */ "vendors~hammerjs").then(__webpack_require__.t.bind(null, /*! hammerjs */ "./node_modules/hammerjs/hammer.js", 7)).then(Hammer => {
        console.log('完成加载');
        resolve(Hammer);
      });
    });
